...
$images = [
     ...
     $get_url . "assets/image/card-1.svg",
     $get_url . "assets/image/card-2.svg",
];
?>
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)"><!-- wp:group {"align":"wide","layout":{"type":"constrained","contentSize":"560px","justifyContent":"left"}} -->
<div class="wp-block-group alignwide"><!-- wp:heading {"textAlign":"left","textColor":"heading","className":"wp-block-heading"} -->
<h2 class="wp-block-heading has-text-align-left has-heading-color has-text-color"><?php esc_html_e( 'Everything you need to create amazing websites', 'spectra-one' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left"} -->
<p class="has-text-align-left"><?php esc_html_e( 'Interactive design tools and its many customization options to customize anything and everything needed to build the fully-functional website of your dreams.', 'spectra-one' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:heading {"level":4,"textColor":"heading","className":"wp-block-heading"} -->
<h4 class="wp-block-heading has-heading-color has-text-color"><?php esc_html_e( 'Huge Design Collection', 'spectra-one' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"padding":{"right":"var:preset|spacing|small"}}}} -->
<p style="padding-right:var(--wp--preset--spacing--small)"><?php esc_html_e( 'Imperdiet etiam scelerisque convallis pulvinar laoreet. Enim imperdiet nullam ullamcorper tempus vivamus eget leo elementum. Sed platea pellentesque nulla egestas porttitor.', 'spectra-one' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group has-surface-background-color has-background" style="border-radius:16px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:image {"id":149,"width":48,"height":48,"sizeSlug":"large","linkDestination":"none","className":"swt-duotone-primary"} -->
<figure class="wp-block-image size-large is-resized swt-duotone-primary"><img src="<?php echo esc_url( $images[1] ); ?>" alt="" class="wp-image-149" width="48" height="48"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70)"><!-- wp:heading {"level":4,"textColor":"heading","className":"wp-block-heading"} -->
<h4 class="wp-block-heading has-heading-color has-text-color"><?php esc_html_e( 'Outstanding Performance', 'spectra-one' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"padding":{"right":"var:preset|spacing|small"}}}} -->
<p style="padding-right:var(--wp--preset--spacing--small)"><?php esc_html_e( 'In nisl enim vulputate varius. Nec sodales elit duis ornare. Non lectus elementum maecenas sit eu orci proin mauris netus.', 'spectra-one' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-group has-surface-background-color has-background" style="border-radius:16px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:image {"id":148,"width":48,"height":48,"sizeSlug":"large","linkDestination":"none","className":"swt-duotone-primary"} -->
<figure class="wp-block-image size-large is-resized swt-duotone-primary"><img src="<?php echo esc_url( $images[2] ); ?>" alt="" class="wp-image-148" width="48" height="48"/></figure>
<!-- /wp:image -->
