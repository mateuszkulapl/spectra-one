...
<div class="wp-block-group"
    ...
    <!-- wp:columns {"align":"wide","style":{"border":{"radius":"24px"},"spacing":{"blockGap":{"top":"var:preset|spacing|medium","left":"var:preset|spacing|medium"},"padding":{"top":"var:preset|spacing|medium","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"primary"} -->
    <div class="wp-block-columns alignwide has-primary-background-color has-background"
        style="border-radius:24px;padding-top:var(--wp--preset--spacing--medium);padding-right:0;padding-bottom:0;padding-left:0">
        ...
        <div class="wp-block-column is-vertically-aligned-top"
            ...
            <div class="wp-block-group">
                ...
                <div class="wp-block-group">
                    <!-- wp:heading {"level":4,"textColor":"background","className":"wp-block-heading"} -->
