...
<h2 class="has-text-align-left wp-block-heading has-heading-color has-text-color">Everything you need to create amazing websites</h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-large is-resized has-custom-border"><img src="<?php echo esc_url( $images[1] ); ?>" alt="" class="wp-image-149" style="border-radius:8px" width="48" height="48"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group has-surface-background-color has-background" style="border-radius:16px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:image {"id":150,"width":48,"height":48,"sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":"8px"}}} -->
<figure class="wp-block-image size-large is-resized has-custom-border"><img src="<?php echo esc_url( $images[2] ); ?>" alt="" class="wp-image-150" style="border-radius:8px" width="48" height="48"/></figure>
<!-- /wp:image -->
<!-- wp:group {"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":4,"textColor":"heading","className":"wp-block-heading"} -->
<h4 class="wp-block-heading has-heading-color has-text-color">Outstanding Performance</h4>
