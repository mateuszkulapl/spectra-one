<?php
/**
 * Title: Footer default inverse
 * Slug: spectra-one/footer-default-inverse
 * Categories: footer
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|large","padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|medium"}}},"backgroundColor":"heading","textColor":"background","layout":{"type":"constrained"}} -->
...
<div class="wp-block-column" style="padding-bottom:var(--wp--preset--spacing--xx-small)"><!-- wp:image {"id":1048,"sizeSlug":"full","linkDestination":"none","className":"swt-duotone-tertiary"} -->
