<?php
/**
 * Title: Footer six columns menu separated inverse
 * Slug: spectra-one/footer-six-columns-menu-separated-inverse
 * Categories: footer
...
<div class="wp-block-group has-background-color has-heading-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--medium)"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|xx-small"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
...
<div class="wp-block-group"><!-- wp:image {"id":1048,"width":121,"height":32,"sizeSlug":"full","linkDestination":"none","className":"swt-duotone-tertiary"} -->
<figure class="wp-block-image size-full is-resized swt-duotone-tertiary"><img src="<?php echo esc_url( $images[0] ); ?>" alt="" class="wp-image-1048" width="121" height="32"/></figure>
<!-- /wp:image -->
...
<!-- wp:separator {"align":"wide","backgroundColor":"body","className":"is-style-wide"} -->
<hr class="wp-block-separator alignwide has-text-color has-body-color has-alpha-channel-opacity has-body-background-color has-background is-style-wide"/>
<!-- /wp:separator -->
