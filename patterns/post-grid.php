...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)"><!-- wp:heading {"textAlign":"left","align":"wide","textColor":"heading","className":"wp-block-heading"} -->
<h2 class="alignwide has-text-align-left wp-block-heading has-heading-color has-text-color">Latest from The Blog</h2>
<!-- /wp:heading -->
