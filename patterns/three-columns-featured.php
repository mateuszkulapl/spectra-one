...
<h5 class="wp-block-heading has-heading-color has-text-color" style="margin-top:var(--wp--preset--spacing--small)">Core WP Blocks</h5>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<!-- /wp:image -->
<!-- wp:heading {"level":5,"style":{"spacing":{"margin":{"top":"var:preset|spacing|small"}}},"textColor":"heading","className":"wp-block-heading"} -->
<h5 class="wp-block-heading has-heading-color has-text-color" style="margin-top:var(--wp--preset--spacing--small)">Easy Customizable</h5>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Endless use-cases that make it highly flexible, adaptable, and scalable for everyone.</p>
<!-- /wp:paragraph --></div>
...
<!-- /wp:image -->
<!-- wp:heading {"level":5,"style":{"spacing":{"margin":{"top":"var:preset|spacing|small"}}},"textColor":"heading","className":"wp-block-heading"} -->
<h5 class="wp-block-heading has-heading-color has-text-color" style="margin-top:var(--wp--preset--spacing--small)">Growing Library</h5>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Endless use-cases that make it highly flexible, adaptable, and scalable for everyone.</p>
<!-- /wp:paragraph --></div>
